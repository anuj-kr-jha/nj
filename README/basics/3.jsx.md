 ...
 *
 * We can use any js expression inside jsx using {}
 */
...
NOTE:
JSX also sanitizes the html tags and attributes.
for eg if we call third party api and get some html from it and render it using dangerouslySetInnerHTML, it will sanitize the html and remove the script tags and other malicious tags.
